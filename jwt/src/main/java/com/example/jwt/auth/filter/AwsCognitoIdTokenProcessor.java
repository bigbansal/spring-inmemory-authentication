...
import com.example.jwt.auth.config.JwtConfiguration;
import com.example.jwt.auth.config.JwtIdTokenCredentialsHolder;
...
public class AwsCognitoIdTokenProcessor {
    ...
    public JwtAuthentication getAuthentication(HttpServletRequest request) throws Exception {
        ...
        if (idToken != null) {
            ...
            if (username != null) {
                ...
                //System.out.println("username2 : "+ jwtIdTokenCredentialsHolder.getIdToken());
