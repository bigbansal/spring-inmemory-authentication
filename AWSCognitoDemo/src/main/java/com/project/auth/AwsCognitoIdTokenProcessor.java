...
import com.project.auth.JwtAuthentication;
import com.project.auth.JwtConfiguration;
    ...
    public Authentication authenticate(HttpServletRequest request) throws Exception {
        ...
        if (idToken != null) {
            ...
            if (username != null) {
                ...
                List<GrantedAuthority> grantedAuthorities = this.jwtConfiguration.getAllowedRoles().stream()
